...
public:
	...
	//int my_algorithm_pos_test(std::string imgs_path_t, int continue_normal_t = 22, int reg_score_t = 13, int blur_degree_t = 14);good para
	int my_algorithm_pos_test(std::string imgs_path_t, int continue_normal_t, int reg_score_t, int blur_degree_t);
	...
	double test_hoist(cv::String imgs_path, cv::String test_y, int continue_normal_t,
		int reg_score_t, int blur_degree_t, bool is_write_line_data = false);
};
